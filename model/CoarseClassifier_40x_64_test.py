...
#load in testset
test_set = datasets.ImageFolder('/projects/academic/scottdoy/projects/CRC_pytorch_chenyu/src/data/test_WSI_TCGA_nuclei/nuclei10/' ,transform=transforms.Compose([
...
saved_model = torch.load('crc_checkpoint_twoclass_40x_64_jitter_e80_more_f3.pth.tar', map_location='cpu')
...
with open('coarseclassifier_40x_64_jitter_e80_more_f3_pred_WSI_TCGA_test_nuclei10.txt', 'w') as f:
