...
#load in dataset
train_set_1 = datasets.ImageFolder('/projects/academic/scottdoy/projects/CRC_pytorch_chenyu/src/data/train_threeclass_640_f1',transform=transforms.Compose([
...
train_set_2 = datasets.ImageFolder('/projects/academic/scottdoy/projects/CRC_pytorch_chenyu/src/data/train_threeclass_640_f2',transform=transforms.Compose([
                                                            transforms.Resize(64),
                                                            transforms.RandomHorizontalFlip(),
                                                            transforms.RandomVerticalFlip(),
                                                            transforms.ColorJitter(0.5, 0.075, 0.075, 0.075),
...
test_set = datasets.ImageFolder('/projects/academic/scottdoy/projects/CRC_pytorch_chenyu/src/data/train_threeclass_640_f3' ,transform=transforms.Compose([
                                                            transforms.Resize(64),
                                                            transforms.RandomHorizontalFlip(),
                                                            transforms.RandomVerticalFlip(),
                                                            transforms.ColorJitter(0.5, 0.075, 0.075, 0.075),
...
def train(epoch):
    ...
    writer = ExcelWriter('result_threeclass_640_4x_retrain_f1_train.xlsx')
...
def test(epoch):
    ...
    for data, target in test_loader:
        ...
        with torch.no_grad():
            ...
            output = clf(data)
            test_loss += F.nll_loss(output, target).item()   #.data[0]
            pred = output.data.max(1)[1]  # get the index of the max log-probability
    ...
    writer = ExcelWriter('result_threeclass_640_4x_retrain_f1_test.xlsx')
...
# Save the model
torch.save(clf.state_dict(), 'crc_checkpoint_threeclass_4x_640_retrain_f1.pth.tar')

# Load parameters back
clf_trained = CNNClassifier()
saved_model = torch.load('crc_checkpoint_threeclass_4x_640_retrain_f1.pth.tar')
